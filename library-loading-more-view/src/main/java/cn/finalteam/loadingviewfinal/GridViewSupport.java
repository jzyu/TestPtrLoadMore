...
public class GridViewSupport extends GridView {
    ...
    private ArrayList<OnScrollListener> mOnScrollListenerList = new ArrayList<>();
    private ArrayList<OnItemSelectedListener> mOnItemSelectedListenerList = new ArrayList<>();
    ...
    public GridViewSupport(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderGridView();
    }

    public GridViewSupport(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addOnScrollListener(OnScrollListener onScrollListener) {
        if (onScrollListener != null && !mOnScrollListenerList.contains(onScrollListener)) {
            mOnScrollListenerList.add(onScrollListener);
        }
    }

    public void removeOnScrollListener(OnScrollListener onScrollListener) {
        if (onScrollListener != null) {
            mOnScrollListenerList.remove(onScrollListener);
        }
    }
    ...
    public void addOnItemSelectedListener(OnItemSelectedListener onItemSelectedListener) {
        if (onItemSelectedListener != null && !mOnItemSelectedListenerList.contains(onItemSelectedListener)) {
            mOnItemSelectedListenerList.add(onItemSelectedListener);
        }
    }

    public void removeOnItemSelectedListener(OnItemSelectedListener onItemSelectedListener) {
        if (onItemSelectedListener != null) {
            mOnItemSelectedListenerList.remove(onItemSelectedListener);
        }
    }
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            int realLeft = GridViewSupport.this.getPaddingLeft() + getPaddingLeft();
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = GridViewSupport.this.getMeasuredWidth()
                    - GridViewSupport.this.getPaddingLeft()
                    - GridViewSupport.this.getPaddingRight();
     ...
     */
    protected static class HeaderViewGridAdapter implements WrapperListAdapter, Filterable {
